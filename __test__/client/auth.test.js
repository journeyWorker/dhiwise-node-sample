...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kasey_Swift',
      password: 'uSUje7KIW1uMD7V',
      email: 'Fabiola22@gmail.com',
      name: 'Loren Goyette',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Representative',
          address1: 'distributed',
          address2: 'Table',
          landmark: 'Saint',
          city: 'flexibility',
          isDefault: false,
      ...
      userType: 323,
      mobileNo: '(906) 018-0642',
      resetPasswordLink: {},
      loginRetryLimit: 452,
      loginReactiveTime: '2023-11-15T20:35:21.386Z',
      id: '639083513cef7ab53ebbac8d'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Trudie68',
        'password':'d9Y3siMmow7ewLT',
        'email':'David.Wintheiser38@hotmail.com',
        'name':'Elsa Marks',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Switchable',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'reintermediate'
        }],
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(279) 643-8796',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'David.Wintheiser38@hotmail.com', });
