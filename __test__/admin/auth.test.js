...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Mina83',
      password: 'xs_BqoWxvxjZHam',
      email: 'Vince.Murazik81@hotmail.com',
      name: 'Johnathan Veum MD',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Steel',
          address1: 'copy',
          address2: 'Bedfordshire',
          landmark: 'Exclusive',
          city: 'impactful',
          isDefault: true,
          state: 'Assistant',
          addressType: 'wireless',
          fullName: 'Visionary',
          mobile: 548,
          addressNo: 93
        }
      ...
      userType: 39,
      mobileNo: '(695) 643-6433',
      resetPasswordLink: {},
      loginRetryLimit: 89,
      loginReactiveTime: '2023-03-28T17:10:23.794Z',
      id: '639083513cef7ab53ebbabb5'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Diamond13',
        'password':'fMPwaW_4gVgbbWm',
        'email':'Deshaun75@gmail.com',
        'name':'Miss Chester Frami',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Marketing',
          'address1':'red',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'Fundamental'
        }],
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(910) 462-3381',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Deshaun75@gmail.com', });
