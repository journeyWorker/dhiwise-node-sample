...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Spencer_Brown83',
      password: 'MzICjWVJ7JDae5U',
      email: 'Trycia.Raynor@hotmail.com',
      ...
      userType: 278,
      mobileNo: '(343) 790-5667',
      resetPasswordLink: {},
      loginRetryLimit: 609,
      loginReactiveTime: '2023-04-04T18:18:39.230Z',
      id: '639083513cef7ab53ebbac21'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Robb15',
        'password':'t5gsst42ZceUaWe',
        'email':'Esmeralda_Reilly@yahoo.com',
        'name':'Marguerite Johnston',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Assistant',
          'address1':'Vermont',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Esmeralda_Reilly@yahoo.com', });
